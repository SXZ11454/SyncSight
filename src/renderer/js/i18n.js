...
const I18n = {
  ...
  TRANSLATIONS: {
    'zh-CN': {
      ...
      "personalize": { "title": "\u4e2a\u6027\u5316", "darkMode": "\u6df1\u8272\u6a21\u5f0f", "language": "\u8bed\u8a00" },
    ...
    'en-US': {
      ...
      "personalize": { "title": "Personalization", "darkMode": "Dark Mode", "language": "Language" },
  ...
  init(defaultLang) {
    ...
    this._currentLang = saved && this.TRANSLATIONS[saved] ? saved : defaultLang;
  ...
  setLanguage(langCode) {
    if (!this.TRANSLATIONS[langCode]) {
      console.warn('[I18N] Language not available:', langCode);
      return false;
    }
